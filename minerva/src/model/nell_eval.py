...
def nell_eval(model_answers, correct_answers):
    """
    NELL evaluation function that calculates Mean Average Precision (MAP)
    
    Args:
        model_answers: Path to file containing model predictions
        correct_answers: Path to file containing correct test pairs
