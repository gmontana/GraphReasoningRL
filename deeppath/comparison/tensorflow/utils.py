...
# hyperparameters
state_dim = 200
# Reduced action space to match the actual number of relations
action_space = 10  # Use a small value that covers the observed relations (6)
eps_start = 1
eps_end = 0.1
epe_decay = 1000
...
# Update to use absolute path for better reliability
import os
repo_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "../.."))
dataPath = os.path.join(repo_root, 'NELL-995/')
